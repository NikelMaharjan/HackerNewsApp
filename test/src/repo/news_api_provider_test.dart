...
void main() {
  ...
  test("fetch top ids indeed returns a list of ids", () async{
    ...
    apiProvider.client = MockClient((request) async{   //MockClient will mock .client
...
/*  test("fetch top ids from actual server ", () async {
    final apiProvider = NewsApiProvider();
...
/*  test("fetch item indeed returns a item model from server", () async{
